...
public class MorpheusAddOneiroCommand extends AbstractPlayerCommand
{
    private final DefaultArg<Integer> amountArg;

    public MorpheusAddOneiroCommand()
    {
        super("addOneiro", "Add yourself Oneiro");
    ...
    protected void execute(@Nonnull CommandContext context, @Nonnull Store<EntityStore> store, @Nonnull Ref<EntityStore> ref, @Nonnull PlayerRef playerRef, @Nonnull World world)
    {
        ...
        playerRef.sendMessage(Message.raw("You added %d Oneiro to yourself".formatted(_amount)));
        GiveOneiroEvent.dispatch(ref, _amount);
    }
}
