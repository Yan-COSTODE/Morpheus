...
public class MorpheusUnlearnCommand extends AbstractPlayerCommand
{
    private final RequiredArg<String> idArg;

    public MorpheusUnlearnCommand()
    {
        super("unlearn", "Unlearn an item");
    ...
    protected void execute(@Nonnull CommandContext context, @Nonnull Store<EntityStore> store, @Nonnull Ref<EntityStore> ref, @Nonnull PlayerRef playerRef, @Nonnull World world)
    {
        ...
        playerRef.sendMessage(Message.raw("You unlearned %s".formatted(_id)));
        UnlearnItemEvent.dispatch(ref, _id);
    }
}
